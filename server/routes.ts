...
export async function seedDatabase() {
  ...
  if (Object.keys(content).length === 0) {
    ...
    await storage.updateContentBlock('services', [
      { id: "1", title: "Технический план объекта", description: "Подготовка технического плана для постановки дома, бани, гаража на кадастровый учет", price: "от 8 000 ₽", icon: "FileText", image: "" },
      { id: "2", title: "Межевой план", description: "Определение и закрепление границ земельного участка, разделы и объединения", price: "от 7 000 ₽", icon: "MapPin", image: "" },
      { id: "3", title: "Акт обследования", description: "Документ для снятия объекта недвижимости с учета при сносе", price: "от 5 000 ₽", icon: "Ruler", image: "" },
      { id: "4", title: "Перевод в жилое", description: "Перевод нежилого дома в СНТ в жилой с полным сопровождением", price: "от 18 000 ₽", icon: "Home", image: "" },
      { id: "5", title: "Экспертиза объекта", description: "Строительная и землеустроительная экспертиза любой сложности", price: "от 20 000 ₽", icon: "Scale", image: "" },
      { id: "6", title: "Консультация", description: "Бесплатная консультация в сфере земельно-имущественных отношений", price: "Бесплатно", icon: "Award", image: "" },
    ]);
